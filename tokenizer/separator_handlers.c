...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/03/27 00:08:18 by tbella-n          #+#    #+#             */
/*   Updated: 2024/03/28 20:51:55 by tbella-n         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// 	{
// 		*line_ptr += 2;
// 		return (ft_append_separator(TOKEN_HEREDOC, line_ptr, token_list));
// 	}
// 	return (0);
// }

// int	ft_handle_append_output_redirection(char 
// **line_ptr, t_token **token_list)
// {
// 	if (!ft_strncmp(*line_ptr, ">>", 2))
// 	{
// 		*line_ptr += 2;
